...
- **Python for both the API and detection.** I chose Python because it is the standard language for computer vision: OpenCV supports it directly and installs as a regular package. A Go/GoCV alternative would have needed a source-built OpenCV 4 on every machine.
